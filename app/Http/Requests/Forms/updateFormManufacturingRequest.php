...
class updateFormManufacturingRequest extends FormRequest
{
    ...
    {
        return [
            'organization_id' => ['required', 'exists:organizations,id', Rule::unique('manufacturing_data')->ignore($this->id)],
